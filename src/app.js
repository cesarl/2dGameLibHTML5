...
var App, Canvas, Collection, Event, Img, Node, Pubsub, Reader, Square, Texture, Tile, Update,
  __slice = [].slice;
...
Node = (function() {
  ...
  Node.prototype.drawTile = function(canvas, tile, square) {
    var _this = this;
    if (tile == null) {
      tile = this.tile;
    }
    ...
    this._drawTile = new Update(1, -1, (function() {
      return _this.drawImgSquare(canvas, tile, square);
    }));
    return this;
  };

  Node.prototype.drawTexture = function(canvas, texture, square) {
    var _this = this;
    if (texture == null) {
    ...
    this._drawTexture = new Update(1, -1, (function() {
      return _this.drawImgColSquare(canvas, texture, square);
    }));
    return this;
  };
...
(function(document) {
  var COL_col, COL_ctx, COL_evt, COL_img, COL_node, cycle, facade, filterSelector, filterSelectorsCollection, gImg, gsCol, gsCtx, gsEvt, gsNode, parseSelectors, _cycleRunning, _global, _name, _oldDD, _pubsub;
  _name = "2dGameLib";
  _global = this;
  _oldDD = _global.DD;
  _cycleRunning = false;
  ...
  facade.loadImage = function(collection, index, callback) {
    var _this = this;
    return COL_img[collection[index].name] = new Img(collection[index].src, function() {
      if (collection[++index]) {
