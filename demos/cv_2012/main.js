...
var big_tree_tile, butterfly_tile, cat_veto_tile, child_tile, childhood, chute, chute_anar_tile, chute_bottle_tile, chute_coco_tile, chute_heart_tile, chute_hippie_tile, chute_me_tile, chute_sky_tile, chute_wall_tile, cosmos_tile, earth_tile, end, little_tree_tile, moon_tile, sky_tile, smoke_tile, spuf_tile, text, veto_tile,
  _this = this;
...
childhood.start = function() {
  ...
  return DD("#butterfly")._spawn = DD("#butterfly").addCycle(100, -1, function() {
    var node;
    node = DD.newNode().addSquare(22, 27, 800, 250 + Math.floor(Math.random() * 250)).addTile(butterfly_tile, DD("@img")).animateTile(0, 1, false, 4, -1).drawTile(DD("!canvas"));
      ...
      return DD(".earth").slideTo(0, 500, 40, function() {
        return DD(".btree").slideTo(0, 175, 40, function() {
          return DD(".ltree").slideTo(0, 353, 40, function() {
            DD(".spuf").addSquare(120, 120, 120, 120).addTile(spuf_tile, DD("@spuf")).drawTile(DD("!canvas")).follow(DD(".child"), 0, 20).animateTile(0, 5, true, 2, 6, (function() {
              return DD(".spuf").kill();
            }));
